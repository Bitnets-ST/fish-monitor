<template>
  <div class="marine-icon-container">
    <div class="marine-icon" :class="[normalizedIconType, animationClass]">
      <!-- Concha marina -->
      <svg v-if="normalizedIconType === 'shell'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class="w-8 h-8">
      ...
      <!-- Medusa -->
      <svg v-else-if="normalizedIconType === 'jellyfish'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class="w-8 h-8">
      ...
      <!-- Pez -->
      <svg v-else-if="normalizedIconType === 'fish'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class="w-8 h-8">
