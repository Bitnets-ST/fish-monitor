  ...
  <aside class="sidebar">
    ...
    <nav class="menu border-t border-gray-200 dark:border-gray-700">
      <ul class="menu-list pt-4">
        <li>
          <a href="#" @click.prevent="$emit('reset-dashboard')" class="menu-item active">
        ...
        <li>
          <a href="#" @click.prevent="$emit('show-cameras')" class="menu-item">
            <div class="icon-wrapper">
              <svg xmlns="http://www.w3.org/2000/svg" class="menu-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
        ...
        <li>
          <a href="#" @click.prevent="$emit('show-statistics')" class="menu-item">
            <div class="icon-wrapper">
              <svg xmlns="http://www.w3.org/2000/svg" class="menu-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
        ...
        <li>
          <a href="#" @click.prevent="$emit('show-user-profile')" class="menu-item">
            <div class="icon-wrapper">
              <svg xmlns="http://www.w3.org/2000/svg" class="menu-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
